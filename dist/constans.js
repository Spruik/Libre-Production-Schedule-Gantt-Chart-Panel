...
System.register([], function (_export, _context) {
  ...
  var STATE_PLAN, STATE_READY, STATE_FLAG, STATE_START, STATE_PAUSE, STATE_COMPLETE, STATE_CLOSE, STATE_CHANGEOVER, STATE_DELETED, STATE_REPLACED;
  return {
    setters: [],
    execute: function () {
      ...
      _export('STATE_CHANGEOVER', STATE_CHANGEOVER = 'changeover');

      _export('STATE_CHANGEOVER', STATE_CHANGEOVER);
