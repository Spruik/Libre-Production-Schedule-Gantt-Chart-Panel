...
System.register(['./data_processor', './utils', './order_actions_ctrl', './drop_order_ctrl', './libs/echarts.min', 'moment'], function (_export, _context) {
    ...
    var dp, utils, order_actions, dropCtrl, echarts, moment, HEIGHT_RATIO, DIM_CATEGORY_INDEX, DIM_TIME_ARRIVAL, DIM_TIME_DEPARTURE, DATA_ZOOM_AUTO_MOVE_THROTTLE, DATA_ZOOM_X_INSIDE_INDEX, DATA_ZOOM_Y_INSIDE_INDEX, DATA_ZOOM_AUTO_MOVE_SPEED, DATA_ZOOM_AUTO_MOVE_DETECT_AREA_WIDTH, _draggable, _draggingEl, _dropShadow, _draggingCursorOffset, _draggingTimeLength, _draggingRecord, _dropRecord, _cartesianXBounds, _cartesianYBounds, _rawData, _autoDataZoomAnimator, _myChart, _panelCtrl;
    ...
    function interationSetup(myChart, panelCtrl) {
        _myChart = myChart;
    ...
    function initDrag(myChart) {
        ...
        function updateRawData() {
            ...
            for (var i = 0; i < orderData.length; i++) {
                ...
                if (dataItem !== movingItem && _dropRecord.categoryIndex === dataItem[DIM_CATEGORY_INDEX] && _dropRecord.timeArrival < dataItem[DIM_TIME_DEPARTURE] && _dropRecord.timeArrival > dataItem[DIM_TIME_ARRIVAL]) {
    ...
    return {
        ...
        execute: function () {
            ...
            _draggingTimeLength = void 0;
            _draggingRecord = void 0;
            _dropRecord = void 0;
            _cartesianXBounds = [];
            _cartesianYBounds = [];
            _rawData = void 0;
            _autoDataZoomAnimator = void 0;
            _myChart = void 0;
            _panelCtrl = void 0;
        }
    };
});
//# sourceMappingURL=chart_option.js.map
